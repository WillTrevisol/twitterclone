...
import 'package:twitterclone/app/features/tweet/views/tweet_comment_view.dart';
...
class TweetCard extends ConsumerWidget {
  ...
  void navigateToCommentView(BuildContext context, Tweet tweet) {
    Navigator.push(context, TweetCommentView.route(tweet: tweet));
  }
    ...
    return currentUser == null ? const DefaultLoading() : ref.watch(getUserDataProvider(tweet.userId)).when(
      data: (user) {
        return GestureDetector(
          onTap: () => navigateToCommentView(context, tweet),
          child: Row(
